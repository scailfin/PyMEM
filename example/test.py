...
def main():
    ...
    momenta = [
        [0.5000000e03, 0.0000000e00, 0.0000000e00, 0.5000000e03],  # gluon
        [0.5000000e03, 0.0000000e00, 0.0000000e00, -0.5000000e03],  # gluon
        [0.5000000e03, 0.1040730e03, 0.4173556e03, -0.1872274e03],  # t
        [0.5000000e03, -0.1040730e03, -0.4173556e03, 0.1872274e03],  # t~
    ]
    # fortran/C-python do not order table in the same order
    transposed_momenta = np.array(momenta).T.tolist()

    n_helicity = -1  # -1 means sum over all helicity
